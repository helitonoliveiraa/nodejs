...
${bold}${NODENAME} is no longer actively supported!${normal}
   ...
   * ${green}https://deb.nodesource.com/setup_12.x — Node.js 12 LTS \"Carbon\"${normal} (recommended)
   * ${green}https://deb.nodesource.com/setup_13.x — Node.js 10 Current${normal}
...
This script, located at ${bold}https://deb.nodesource.com/setup${normal}, used to
   ...
   * ${green}https://deb.nodesource.com/setup_12.x — Node.js 12 LTS \"Carbon\"${normal} (recommended)
   * ${green}https://deb.nodesource.com/setup_12.x — Node.js 13 Current${normal}
